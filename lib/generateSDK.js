...
module.exports = (configs) => {
  const { files, prefix: appPrefix, path = process.cwd(), sdkFile = "sdk.gen.js", disableSocket } = configs;

  let file = `\n// This file is auto generated by '${package.name}' lib\n\n`;
  file += `import sdkFetch, { setConfig } from "${package.name}/lib/fetcher"\n\n`;
  file += `import useSdkFetch from "${package.name}/lib/useFetcher"\n\n`;

  appPrefix && (file += `setConfig({ baseUrl: '${appPrefix}', disableSocket: ${!!disableSocket} })\n\n`);
